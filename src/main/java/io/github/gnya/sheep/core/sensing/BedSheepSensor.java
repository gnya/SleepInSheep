package io.github.gnya.sheep.core.sensing;
...
public class BedSheepSensor extends Sensor<LivingEntity> {
  ...
  public @NonNull Set<MemoryModuleType<?>> requires() {
    return Set.of(MemoryModuleType.NEAREST_LIVING_ENTITIES, ModMemoryModuleTypes.NEAREST_BED_SHEEP);
  }
  ...
  protected void setNearestBedSheep(final LivingEntity body, final List<LivingEntity> entities) {
    ...
    body.getBrain().setMemory(ModMemoryModuleTypes.NEAREST_BED_SHEEP, sheep);
  }
}
